...
export const alt = 'Bamboo Cat Litter - Sustainable & Eco-Friendly';
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            {[
              { icon: '🌱', label: 'Fast Growing' },
              { icon: '💧', label: 'Super Absorbent' },
        ...
        >
          ecocatlitters.com/litter-types/bamboo
        </div>
      </div>
    ),
    {
