...
const paperFAQs = [
  ...
  },
  {
    ...
    answer: 'Paper litter\'s main weakness is odor control—it absorbs but doesn\'t neutralize odors. To manage smells, scoop frequently, add baking soda, use an activated carbon supplement like <a href="https://www.purrify.ca/products?utm_source=ecocatlitters">Purrify</a>, and replace all litter every 5-7 days.'
  },
  {
